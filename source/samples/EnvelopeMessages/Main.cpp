...
class Catcher : public clang::Actor
{
public:
...
private:
    ...
    inline void Handler(const IntegerVectorEnvelope &envelope, const clang::Address from)
    {
...
int main()
{
    ...
    clang::ActorRef actor(framework.CreateActor<Catcher>());
